...
<ol>
<li /><strong>Introduction to IDG Queries within UBKG</strong>: This section showcases how to map disease-related terms and compounds, using PUBCHEM and SNOMEDUS_CT as examples.
